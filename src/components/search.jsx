    ...
    <div className="flex justify-between max-sm:flex-col gap-6">
      <form className="flex bg-primary shadow min-w-1/3 p-4 space-x-3">
        ...
        <input
          ...
          className="focus:outline-0 capitalize"
        />
      </form>
      <div
        onClick={() => {
        ...
        className="relative  cursor-pointer pointer-events-auto w-[250px] flex items-center justify-between bg-primary  rounded shadow px-8 h-14"
      >
        <p>{"Filter By Region"}</p>
        <IoIosArrowDown className="mt-1 arrow transform rotate-0 transition-all duration-200" />
        <div className="absolute overflow-hidden *:hover:bg-secondary dropDown shadow transition-all duration-150 transform origin-top scale-0 z-10  bg-primary  top-16 left-0  h-fit w-1/1 rounded">
